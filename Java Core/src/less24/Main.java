...
public class Main {
	...
	public static final String CONNECTION_URL = "jdbc:mysql://localhost:3306/devjava4?useSSL=false";
	...
	public static final String CREATE_TABLE_BOOK_QUERY = "CREATE TABLE book(id INT PRIMARY KEY AUTO_INCREMENT,  " + "title VARCHAR(255), person_id INT)";
	
	public static final String ADD_CONSTRAINT_PERSON_BOOK = "ALTER TABLE book ADD CONSTRAIN book_person FOREIGN KEY " +"(person_id) REFERENCES person(id)";
